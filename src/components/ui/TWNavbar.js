    ...
    <header className="bg-white/80 backdrop-blur sticky top-0 z-40 shadow-md">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-3">
          <Link to="/" className="text-slate-700 hover:text-slate-900 px-3 py-2 rounded-md">Home</Link>
          <Link to="/tw-demo" className="text-slate-700 hover:text-slate-900 px-3 py-2 rounded-md">UI Demo</Link>
          <a href="#" className="bg-blue-600 text-white px-4 py-2 rounded-md shadow hover:bg-blue-700">Get Help</a>
        </nav>
      </div>
    </header>
  );
